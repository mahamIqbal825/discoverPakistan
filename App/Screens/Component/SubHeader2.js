      ...
      <>
              ...
              return (
                <>
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      if (
                        data.item.name === "iTrip" ||
                        data.item.name === "Become Contributor"
                      ) {
                        ...
                        // console.log("CHECK ", data.item.name);
                      }
                    }}
                  >
                    <Text
        ...
        <View>
          ...
          {this.state.selected === "Shows" && (
            <Shows navigation={this.props.navigation} />
          )}
          {this.state.selected === "Discover Shop" && (
            <ECommerce navigation={this.props.navigation} />
          )}
          {this.state.selected === "Partners" && (
            <Partners navigation={this.props.navigation} />
          )}
          {this.state.selected === "Advertise" && (
            <AdvertiseWithUs navigation={this.props.navigation} />
          )}
          {this.state.selected === "Pakistan" && (
            <AboutDiscoverPakistan2 navigation={this.props.navigation} />
          )}
          {this.state.selected === "Tourist Community" && (
            <TouristCommunity navigation={this.props.navigation} />
          )}
          {/* {this.state.selected === "Shows" && (
            <Shows navigation={this.props.navigation} />
          )} */}
